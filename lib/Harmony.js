...
var Harmony = /** @class */ (function () {
    ...
    Harmony.isPitchClass = function (note) {
    ...
    Harmony.getPitchesInRange = function (pitches, range) {
        return util_1.noteArray(range).filter(function (n) { return pitches.find(function (p) { return tonal_1.Note.chroma(p) === tonal_1.Note.chroma(n); }); });
